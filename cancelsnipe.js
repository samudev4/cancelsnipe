...
(function() {
    ...
    const cancelDelay = 5000; // 5 segundos (ms)
    ...
    box.innerHTML = `
        ...
        <label>1. Hora de llegada del ataque de la OFENSIVA enemiga (HH:MM:SS:MMM):</label>
        <input id="ataque_enemigo" type="text" placeholder="16:14:51:492">

        <label>2. Duración del viaje de tus tropas (HH:MM:SS:MMM):</label>
        <input id="duracion_viaje" type="text" placeholder="00:31:07:000">

        <label>3. Hora deseada de regreso de tus tropas (HH:MM:SS:MMM):</label>
        ...
        <div id="resultado" class="resultado-box">Introduce datos y pulsa Calcular.</div>
            ...
            <div style="margin-top:8px; font-size:11px; text-align:right; color:#aaa;">
        Hecho por samudev4
    </div>
    ...
    document.getElementById("calcular").onclick = function() {
        ...
        resultado.className = "resultado-box"; // reset clase
